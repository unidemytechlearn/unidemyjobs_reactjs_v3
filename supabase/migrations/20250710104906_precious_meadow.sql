/*
  ...
  1. Sample Companies
    ...
    - Include logos, descriptions, and company information

  2. Sample Jobs
    - Create diverse job listings across different categories
    - Include various job types, experience levels, and salary ranges
    - Mix of featured and regular jobs
    - Different locations including remote options

  3. Data Variety
    - Technology, Design, Marketing, Management roles
    - Entry-level to Senior positions
    - Full-time, Part-time, Contract, Internship, Freelancing
